                    ...
                    <div class="card-body">
                        ...
                        <div class="container">
                            <div class="row" style="text-align:center;paddinf:5px;">
                                <div class="col-md-4">
                                    <div style="background:#FF9800;border-radius:5px;color:#dc3545; height:100%">
                                        <h3 style="padding:5px">Request Appointment <p style="color:#F6412D">
                                                {{ $count_pending }}</p>
                                        </h3>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div style="background:#FF9800;border-radius:5px;color:#dc3545; height:100%">
                                        <h3 style="padding:5px">Today's Appointment <p style="color:#F6412D">
                                                {{ $count_today }}</p>
                                        </h3>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div style="background:#FF9800;border-radius:5px;color:#dc3545;">
                                        <h3 style="padding:5px">Unfinish Appointment <p style="color:#F6412D">
                                                {{ $count_unfinish }}</p>
                                        </h3>
                                    </div>
                                </div>
                            ...
                            <div class="row mt-3">
                                <div class="col-sm-6">
                                    <div
                                        style="background:#fff;width:100%;height:30vh;border-radius:10px;box-shadow: 5px 10px #aaaaaa;">
                                        <div style="text-align:center;padding:5px">
                                            <h3 style="color:#F6412D"><b>Pending Request</b></h3>
                                            @foreach ($appointment as $item)
                                                <p>{{ $item->appointment_sender }} - {{ $item->appointment_type }}</p>
                                            @endforeach
                                            <a href="/admin/view/pending-request"><button id="btn" class="btn"
                                                    style="">View more</button></a>
                                    ...
                                    <div
                                        ...
                                        <div style="text-align:center;padding:5px">
                                            ...
                                            @foreach ($appointmentnow as $item)
                                                <p>{{ $item->appointment_sender }} - {{ $item->appointment_type }}</p>
                                            @endforeach
                                            <a href="/admin/view/current-appointment"><button id="btn"
                                                    class=" btn  ">View more</button></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div
                                        ...
                                        <div style="text-align:center;padding:5px">
                                            ...
                                            @foreach ($monthly_appointment as $item)
                                                <a href="{{ url('/admin/view', $item->id) }}">
                                                    <p>{{ $item->appointment_sender }} - {{ $item->appointment_type }} -
                                                        {{ $item->appointment_date }}</p>
                                                </a>
                                            @endforeach
                                        </div>
                                    </div>
